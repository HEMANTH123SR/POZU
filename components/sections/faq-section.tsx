...
export const FaqSection = () => {
  return (
    <section className="w-screen flex flex-col justify-center items-center border-y-4 border-blue-900 py-24">
      <div className="flex flex-col justify-center items-center w-9/12 space-y-8">
        <h4 className={`text-7xl ${cutAlong.className} text-blue-900`}>
          {" "}
          FAQ - POZU
        </h4>
        <Accordion type="single" collapsible className="w-full ">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Pozu is a platform where users can list pets for sale, adopt pets, 
              find pet services like vets or groomers, and shop for pet-related products.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Pozu provides options to list and adopt pets, find pet services near you, 
              purchase pet goods, and access helpful resources for pet care.
            </AccordionContent>
          </AccordionItem>
